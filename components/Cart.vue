...
<template>
    <div class="flex flex-col gap-5 fixed top-20 size-full max-h-[calc(100%-5rem)] bg-white z-10 shadow-2xl overflow-auto overscroll-contain" :class="{ 'hidden': !cartStore.showCart }">
