...
<template>
    <div class="flex gap-2 h-full">
        <button class="flex items-center justify-center w-full bg-gray-100 hover:bg-gray-50"
                aria-label="Decrease quantity for the product in cart"
                @click="cartStore.decreaseQuantity(id)">
        ...
        <button class="flex items-center justify-center w-full bg-gray-100 hover:bg-gray-50"
                aria-label="Increase quantity for the product in cart"
                @click="cartStore.increaseQuantity(id)">
